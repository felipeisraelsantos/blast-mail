                    ...
                    <tr>
                        ...
                        <x-table.td class="w-1">
                            <div class="flex items-center space-x-4">
                                <x-button.link secondary :href="route('campaign.show', $campaign)">{{ __('Preview') }}</x-button.link>
                                <x-button.link secondary :href="route('campaign.edit', $campaign)">{{ __('Edit') }}</x-button.link>
                                @unless ($campaign->trashed())
                                    <div>
                                        <x-form :action="route('campaign.destroy', $campaign)" delete flat
