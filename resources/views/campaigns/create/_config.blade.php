<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        <x-input.checkbox id="track_click" name="track_click" value="1" :isCheckedWhen="old('track_click', $data['track_click'])" autofocus :label="__('Track click')"/>
        <x-input-error :messages="$errors->get('track_click')" class="mt-2" />
    </div>

    <div>
        <x-input.checkbox id="track_open" name="track_open" value="1" :isCheckedWhen="old('track_open', $data['track_open'])" autofocus :label="__('Track open')"/>
